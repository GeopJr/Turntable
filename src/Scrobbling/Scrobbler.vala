public interface Turntable.Scrobbling.Scrobbler : GLib.Object {
	...
	public virtual void scrobble (Scrobbling.Manager.Payload payload, GLib.DateTime datetime) {
		if (token == "" || url == null || url == "") return;
		scrobble_actual (payload, datetime);
	}
	protected abstract void scrobble_actual (Scrobbling.Manager.Payload payload, GLib.DateTime datetime);
